...
Brush.toGeometry = function(brush) {
    var geometry = new THREE.Geometry();
    for (var i = 0; i < brush.polygons.length; i++) {
        var startFaceIndex = geometry.vertices.length;

        geometry.vertices.push(brush.polygons[i].a);
        geometry.vertices.push(brush.polygons[i].b);
        geometry.vertices.push(brush.polygons[i].c);

        geometry.faces.push( new THREE.Face3(startFaceIndex, startFaceIndex + 1, startFaceIndex + 2) );
    }
